...
class InertActivity2() : AppCompatActivity() {
    ...
    var handler: Handler = object : Handler(Looper.getMainLooper()) {
        override fun handleMessage(msg: Message) {
            ...
            if (msg.what == 0) {
                ...
                Toast.makeText(this@InertActivity2, result, Toast.LENGTH_SHORT).show()
            } else if (msg.what == 1) {
                val result = msg.obj as Boolean
                if (result == true) {
                    Toast.makeText(this@InertActivity2, "삽입 성공", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(this@InertActivity2, "삽입 실패", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
    ...
    internal inner class ThreadEx() : Thread() {
        ...
        override fun run() {
            ...
            try {
                ...
                val fileName: String = "musa.jpeg" //이미지가 존재하는 경우
