...
class MovieAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        //이미지 출력
        val imgView =
            returnView?.findViewById<View>(R.id.movieimage) as ImageView
        ...
        //텍스트 출력
        val titleview = returnView?.findViewById<View>(R.id.movietitle) as TextView
        titleview.text = data[position].title

        val subtitleview = returnView?.findViewById<View>(R.id.moviesubtitle) as TextView
        subtitleview.text = data[position].subtitle

        val ratingview = returnView?.findViewById<View>(R.id.movierating) as RatingBar
