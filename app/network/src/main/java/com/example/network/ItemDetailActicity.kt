...
class ItemDetailActicity : AppCompatActivity() {
    ...
    var handler: Handler = object : Handler(Looper.getMainLooper()) {
        override fun handleMessage(msg: Message) {
            ...
            if (msg.what === 0) {
                ...
                Toast.makeText(this@ItemDetailActicity, str, Toast.LENGTH_SHORT).show()
            } else if (msg.what === 1) {
                ...
                if (bit == null) {
                    Toast.makeText(this@ItemDetailActicity, "bitmap is null", Toast.LENGTH_LONG)
                        .show()
                } else {
